...
- In run lists, the author no longer overlaps the branch and commit when the window is narrow: metadata is truncated and the author is shown only when the row is wide enough.
